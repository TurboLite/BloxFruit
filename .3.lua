...
skipButton.Size = UDim2.new(0, 150, 0, 40)  -- Kích thước nhỏ hơn
skipButton.Position = UDim2.new(1, -160, 0, 20)  -- Vị trí cao hơn và dịch vào trong một chút
skipButton.Text = "Skip Player"
skipButton.TextSize = 20  -- Kích thước chữ nhỏ hơn
