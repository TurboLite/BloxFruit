...
-- Skip Player function (hoạt động ngay lập tức dù có mục tiêu hay không)
function SkipPlayer()
...
skipButton.Size = UDim2.new(0, 100, 0, 30)  -- Kích thước nhỏ hơn
skipButton.Position = UDim2.new(1, -110, 0, 10)  -- Sát cạnh trên bên phải màn hình
skipButton.Text = "Skip Player"
skipButton.TextSize = 16  -- Kích thước chữ nhỏ hơn
...
function SkipPlayer()
    -- Thực hiện hành động bỏ qua ở đây
    print("Player skipped!")
    -- Thêm mã của bạn để bỏ qua player ở đây
end

-- Đoạn mã khác của bạn, nếu có
...
textButton.Position = UDim2.new(0, 10, 1, -200) -- Di chuyển lên cao hơn nữa
...
textButton.Text = "Đổi Server" -- Chữ trên nút
